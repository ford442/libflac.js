...
if((ui8_data.length<44) || (to_string(ui8_data,0,4) != "RIFF") || (to_string(ui8_data,8,16) != "WAVEfmt ") || (to_string(ui8_data,36,40) != "data")){
...
if((ui8_data.length<38+offset) || (to_string(ui8_data,offset-4,offset) != "fLaC")){
...
return {
sample_rate:sample_rate,channels:channels,bps:bps,total_samples:total_samples,block_align:block_align
};
}
