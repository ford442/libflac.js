...
dist/libflac.wasm.js: $(FLAC_LIB) $(PREFILE) $(POSTFILE)
	$(EMCC) $(EMCC_DEF_OPT_LEVEL) $(EMCC_OPTS_WASM_DEFAULT) -sPRINTF_LONG_DOUBLE=1 -sWASM_BIGINT=1 -ffast-math -flto=thin -s MALLOC="emmalloc" -DNDEBUG -sASSERTIONS=0 --pre-js $(PREFILE) --post-js $(POSTFILE) $(FLAC_LIB) -o $@
