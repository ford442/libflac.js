...
EMCC_MAX_OPT_LEVEL_ASMJS_FASTCOMP:=$(EMCC_MAX_OPT_LEVEL) -ggsource-map
EMCC_MAX_OPT_LEVEL_ASMJS_LLVM:=$(EMCC_MAX_OPT_LEVEL) -g3
EMCC_MAX_OPT_LEVEL_WASM:=$(EMCC_MAX_OPT_LEVEL) -ggsource-map
...
EMCC_OPTS_WASM_LLVM:=-s "-mnontrapping-fptoint -fno-fast-math -ffp-contract=off "
